...
class Table {
    ...
    factory Table.fromJson(Map<String, dynamic> json) => Table(
        ...
        index: json["index"],
        tableSale: json["tableSale"] == null ? null : TableSale.fromJson(json["tableSale"]),
    );
...
class MenuItem {
    ...
    factory MenuItem.fromJson(Map<String, dynamic> json) => MenuItem(
        ...
        freePrice: json["freePrice"],
        optionsCategories: json["optionsCategories"] == null ? [] : List<OptionsCategory>.from(json["optionsCategories"]!.map((x) => OptionsCategory.fromJson(x))),
        menuItemsCategory: json["menu_items_category"] == null ? null : MenuItemsCategory.fromJson(json["menu_items_category"]),
    );
    ...
    Map<String, dynamic> toJson() => {
        ...
        "barCode": barCode,
        "freePrice": freePrice,
        "optionsCategories": optionsCategories == null ? [] : List<dynamic>.from(optionsCategories!.map((x) => x.toJson())),
...
class MenuItemsCategory {
    ...
    factory MenuItemsCategory.fromJson(Map<String, dynamic> json) => MenuItemsCategory(
        id: json["id"],
        name: json["name"],
        index: json["index"],
        createdAt: json["createdAt"] == null ? null : DateTime.parse(json["createdAt"]),
...
class OptionsCategory {
    ...
    factory OptionsCategory.fromJson(Map<String, dynamic> json) => OptionsCategory(
        id: json["id"],
